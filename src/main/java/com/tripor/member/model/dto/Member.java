...
public class Member {
	...
	public Member(String userId, String userPw, String userName, String emailId, String emailDomain, int sido,
	...
	public String toString() {
		return "Member [userId=" + userId + ", userPw=" + userPw + ", userName=" + userName + ", emailId=" + emailId
