...
import com.tripor.exception.UnAuthorizedException;
...
//	저장할 data의 key, value
		...
		// JWT 토큰 생성
		String jwt = Jwts.builder().setHeaderParam("typ", "JWT").setClaims(claims) // Header 설정 : 토큰의 타입, 해쉬 알고리즘 정보 세팅.
				.signWith(SignatureAlgorithm.HS256, this.generateKey()).compact(); // Signature 설정 : secret key를 활용한 암호화.
																					// 직렬화 처리.
		return jwt;
	}
